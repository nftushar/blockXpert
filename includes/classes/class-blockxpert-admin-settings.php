...
class BlockXpert_Admin_Settings {
    ...
    public function enqueue_admin_assets($hook) {
        ...
        // Enqueue admin CSS
        $admin_css_path = BLOCKXPERT_PATH . 'includes/assets/css/admin.css';
        $admin_css_url = BLOCKXPERT_URL . 'includes/assets/css/admin.css';
        ...
        $settings_css_path = BLOCKXPERT_PATH . 'includes/assets/css/admin-settings.css';
        $settings_css_url = BLOCKXPERT_URL . 'includes/assets/css/admin-settings.css';
        ...
        $settings_js_path = BLOCKXPERT_PATH . 'includes/assets/js/admin-settings.js';
        $settings_js_url = BLOCKXPERT_URL . 'includes/assets/js/admin-settings.js';
